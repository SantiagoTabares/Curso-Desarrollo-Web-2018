...
function cargarDatos() {
    var datos = [
        ...
        { url: "assts/uploads/actividades/actividad-normal/index.html", nombre: "Determina la operacion", instruccion: "Fijate en los numeros y  selecciona el numero indicado:" },
        { url: "assts/uploads/actividades/actividad-canvas/index.html", nombre: "Actividad canvas", instruccion: "Fijate en los numeros y  selecciona el numero indicado:" }
    ];
    return datos;
}
